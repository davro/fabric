 ...
 *
 * Fabric to invent or produce the act of fabricating, constructing,
...
class FabricEngine extends \DOMDocument
{
    /**
    ...
    /**
     * Main setup function for the Fabric Engine.
     *
    ...
    public function __construct($version = '1.0', $encoding = 'utf-8', $pattern = 'html')
    {
        ...
        $objectName = 'Fabric\\' . ucfirst($pattern);
     ...
     *
     * @return object This current FabricEngine object.
     */
    ...
    public function convert($data)
    {
        ...
        try {
            ...
            return('FabricEngine :: convert : ' . $e->getMessage());
        }
    }
    ...
    {
        // Buffer engine used to convert the html string into DOMElements,
        $fabrication = new FabricEngine;
        $fabrication->run($html);

        // Retrive xpath element from the FabricEngine.
    ...
    public function __call($method, $args)
    {
        ...
        if (preg_match('/^get(.*)/U', $method, $matches)) {
            ...
            if (array_key_exists($nodeName, $doctype['_body'])) {
                ...
                echo "\n";
                echo "The 'FabricEngine' misfired, failed to find an expected element. \n";
            ...
            case 'css':
                if (array_key_exists('header', $options)) {
                    if ($options['header'] === true) {
                        $result.="/**\n";
                        $result.=" * CSS Generated by the FabricEngine.\n";
                        $result.=" */\n";
                    }
                }
                foreach ($this->input as $k => $v) {
